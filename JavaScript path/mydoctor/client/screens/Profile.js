...
const ProfileScreen = (props) => {
  ...
  const confirm = (type) => {
    showAlert(
      type === 'delete' ? 'You are about to delete your account.': 'You are about to logout',
      type === 'delete' ? "Do you want to delete your account?": "Co you want to logout?",
      type
    )
  }
      ...
      <View style={styles.container}>
        ...
        <View>
          <View style={styles.userIconContainer}>
            ...
            <Button buttonStyle={styles.logoutButton} title="Logout" onPress={() => confirm('logout')} />
          </View>
        }
      </View>
    </ScrollView>
